...
# Load original exam
with open("exam16.json", "r", encoding="utf-8") as f:
    exam = json.load(f)
...
# Save merged file
with open("exam16_with_explanations.json", "w", encoding="utf-8") as f:
    json.dump(exam, f, indent=2, ensure_ascii=False)

print("✅ exam16_with_explanations.json created successfully")
